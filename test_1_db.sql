...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 24 2020 г., 19:45
...
INSERT INTO `tables` (`id`, `name`, `quantity_players`, `rates`, `password`) VALUES
(1, 'table1', 5, 100, NULL),
(2, 'table1', 5, 100, NULL);
...
--
-- Структура таблицы `testing_db`
--

CREATE TABLE `testing_db` (
  `id` int(11) NOT NULL,
  `name` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `second name` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `testing_db`
--

INSERT INTO `testing_db` (`id`, `name`, `second name`) VALUES
(1, 'Grisha', 'Shamshurin'),
(2, 'Vasya', 'Pupcin');
...
INSERT INTO `users` (`id`, `login`, `password`, `nickname`, `money`) VALUES
